...
- (void)createGroupWithName:(NSString *)groupName
              ...
              replayHistory:(BOOL)replayHistory
                    ...
                    failure:(void (^)(NSError * error))failure DEPRECATED_MSG_ATTRIBUTE("Use createGroupWithName:membersTokens:avatarUrl:imageData:asRole:replayHistory:success:failure:");
...
- (void)createGroupWithName:(NSString *)groupName
              ...
              replayHistory:(BOOL)replayHistory
                    success:(void(^)(TTGroup *newGroup))success
                    failure:(void (^)(NSError * error))failure DEPRECATED_MSG_ATTRIBUTE("Use createGroupWithName:membersTokens:avatarUrl:imageData:asRole:metadata:replayHistory:success:failure:");
...
- (id)userShiftsWithToken:(NSString *)userToken
                startDate:(NSDate *)startDate
                  endDate:(NSDate *)endDate
        organizationToken:(NSString *)organizationToken
                  success:(void (^)(NSArray <TTShift *>*shifts))success
                  failure:(void (^)(NSError *error))failure;
...
- (id)roleShiftsWithToken:(NSString *)roleToken
                startDate:(NSDate *)startDate
                  endDate:(NSDate *)endDate
        organizationToken:(NSString *)organizationToken
                  success:(void (^)(NSArray <TTShift *>*shifts))success
 ...
 */
- (BOOL)isCalendarServiceEnabledForOrganization:(NSString *)organizationToken;
